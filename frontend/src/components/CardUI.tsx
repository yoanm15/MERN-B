...
function CardUI() {
    ...
    async function addCard(e: any): Promise<void> {
        e.preventDefault();
        const endpoint = buildPath('api/addCard');
    ...
    async function searchCards(e: any): Promise<void> {
        e.preventDefault();

        const endpoint = buildPath('api/searchCards');
    ...
    return (
        <div id="cardUIDiv">
            ...
            <button type="button" id="searchCardButton" className="buttons"
                onClick={searchCards}> Search Card</button><br />
